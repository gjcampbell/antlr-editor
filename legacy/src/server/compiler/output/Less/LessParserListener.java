...
public interface LessParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LessParser#function}.
	 * @param ctx the parse tree
	 */
	void enterFunction(LessParser.FunctionContext ctx);
	/**
	 * Exit a parse tree produced by {@link LessParser#function}.
	 * @param ctx the parse tree
	 */
	void exitFunction(LessParser.FunctionContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterProperty(LessParser.PropertyContext ctx);
	/**
	 * Exit a parse tree produced by {@link LessParser#property}.
	 * @param ctx the parse tree
	 */
	void exitProperty(LessParser.PropertyContext ctx);
	/**
